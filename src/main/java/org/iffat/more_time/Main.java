...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ZonedDateTime dobJakarta = ZonedDateTime.ofInstant(dobInstant, ZoneId.of("Asia/Jakarta"));
        System.out.println("Your kid's birthdate, Jakarta time = " + dobJakarta.format(DateTimeFormatter
                .ofLocalizedDateTime(FormatStyle.MEDIUM)));

        ZonedDateTime dobHere = dobJakarta.withZoneSameInstant(ZoneId.systemDefault());
        System.out.println("Your kid's birthdate, time here = " + dobHere.format(DateTimeFormatter
                .ofLocalizedDateTime(FormatStyle.MEDIUM)));

        ZonedDateTime firstMonth = ZonedDateTime.now()
                .with(TemporalAdjusters.firstDayOfNextMonth());
        System.out.printf("First of next Month = %tD %n", firstMonth);
        ...
        System.out.println("Your 2nd kid's birthdate, time here = " + dob2.format(DateTimeFormatter
                .ofLocalizedDateTime(FormatStyle.MEDIUM)));
